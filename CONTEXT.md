...
| 9 | Training Triple-Hybrid | 🟢 **Model A + B + Late Fusion SELESAI** (24 Jun–6 Jul 2026) — branch `feat/phase9-training`. Layer 1: acc 0,9819 · macro-F1 0,9680 · recall-relevan 0,9674. Layer 2: acc 0,9881 · **macro-F1 0,9767** (phishing F1 0,91 terendah — scam umbrella). Fusion 0,75:0,25 (a priori): L1 recall-relevan +0,87pp (→0,9761, 8 FN diselamatkan), L2 redundan/interpretabilitas. Lihat Temuan #9–#10 |
