...
| 9 | Training Triple-Hybrid | 🟢 **Model A + B SELESAI** (24 Jun 2026) — branch `feat/phase9-training`. Layer 1: acc 0,9819 · macro-F1 0,9680 · recall-relevan 0,9674. Layer 2: acc 0,9881 · **macro-F1 0,9767** (phishing F1 0,91 terendah — scam umbrella). Lihat Temuan #9 |
