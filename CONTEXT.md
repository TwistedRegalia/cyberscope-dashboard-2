...
| 8 | Gold Standard Annotation | 🟡 SAMPLING SIAP (22 Jun 2026) — 357 blind (297 relevan + 60 tidak_relevan), 2 annotator (A&B), skrip `phase8_gold_sampling.py` + `phase8_kappa_analysis.py`. **Anotasi manual BERJALAN** (lihat Temuan #8) |
